...
This is because its impossible to reliably/generically escape arguments on windows.`);
  ...
  const newHeader = inlined_default({ denoVersion: denoVersion2, argsForUnix, argsForWindows });
